...
public class Ayuda implements ActionListener {
	  ...
	  public Ayuda() {
	    ...
	    atras.addActionListener(this);//le pone el listener para el momento de presionarlo
	    ...
	    msg.add(new Label("Saltar Turno : Has click cuando quieras pasar de turno"));
	    ...
	    msg.add(new Label("            y crees que la palabra que formaste no es"));
	    msg.add(new Label("            es la que querias o te equivocaste, este"));
	    msg.add(new Label("            boton regresa la ultima ficha usada durante el turno"));
